        ...
        <div className="col-xl-6 col-lg-6 col-md-12 main-text-box">
          ...
          <div className="main_text">
            ...
            <div className="nairobi_text animate one">
              <span className="singal-text">P</span>
              <span className="singal-text">r</span>
              <span className="singal-text">a</span>
              <span className="singal-text">m</span>
              <span className="singal-text">o</span>
              <span className="singal-text">d</span>
              <span className="singal-text">&nbsp;</span>
              <br />
              <span className="singal-text">K</span>
            </div>
      ...
      <div className="main_page_bottom_text">
        ...
        <div>
          ...
          <div className="media-text">
            ...
            <p className="fb">
              <Link to="https://www.instagram.com/_impramodk/">Ins.</Link>
            </p>
            <p className="fb">
              <Link to="https://dribbble.com/shots/25974853-IdentityShield-Page">Dr.</Link>
            </p>
